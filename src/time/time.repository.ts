...
import {IGetTime, ISaveTime, ITimeRepository, ITimeRepositoryReqDb } from "./time.repository.interface";
...
export class TimeRepository implements ITimeRepository{
    ...
    async saveTime(payload:ISaveTime): Promise<ITimeRepositoryReqDb | null>{
    ...
    async getTime(payload:IGetTime): Promise<ITimeRepositoryReqDb | null>{
    ...
    async getTimeAll(payload: GetTimeAllDto): Promise<ITimeRepositoryReqDb | null>{
    ...
    async allTimeBySelectedDate(user_id:number, date:string):Promise<ITimeRepositoryReqDb | null>{
        return await db.query(
    ...
    async getAllUserTime(user_id:number):Promise<ITimeRepositoryReqDb | null>{
